...
LANG_CHECK_PORT="Checking port 8018..."
...
LANG_PORT_OCCUPIED="Port 8018 is already occupied (change SERVER_PORT in .env)"
...
LANG_NEXT_STEP1="Open the \"Access URL\" shown above (default http://<device-ip>:8018)"
